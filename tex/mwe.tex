...
{{=<< >>=}}
\setproperty{agreement}{number}{<< number >>}

%\setproperty{agreement}{number}{0912345}
%------------------------------
...
%\setproperty{member}{Name}{Jonas Jonaitis}
%\setproperty{member}{address}{Gatvė, namas, miestas}
%\setproperty{member}{phone}{<< +370 650 123456 >>}
%\setproperty{member}{email}{<< tikras@e.mailas >>}

<<#member>>
\setproperty{member}{Name}{<< Name >>}
\setproperty{member}{address}{<< address >>}
\setproperty{member}{phone}{<< phone >>}
\setproperty{member}{email}{<< email >>}
...
%\centering \date, \getproperty{organization}{location}}


\textbf{\getproperty{organization}{name}} ir 
\textbf{\getproperty{member}{Name}}, toliau vadinamas „nariu“, sudarė šią sutartį:
